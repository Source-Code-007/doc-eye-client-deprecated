                ...
                <div className='bg-white rounded-lg p-3 md:p-4 shadow'>
                    <div className='flex items-center gap-3 mb-4 md:mb-5'>
                        ...
                        <div className='space-y-1'>
                            ...
                            <p className='text-primary-desc text-xs sm:text-sm'>Total patient visited to your portal in this month</p>
                        </div>
                    </div>
                    <div className='flex justify-between gap-3'>
                        <h2 className='font-bold text-md md:text-lg lg:text-xl xl: text-2xl'>1550</h2>
                        <div className='flex items-center gap-1 text-xs md:text-md'>
                ...
                <div className='bg-white rounded-lg p-3 md:p-4 shadow'>
                    <div className='flex items-center gap-3 mb-4 md:mb-5'>
                        ...
                        <div className='space-y-1'>
                            ...
                            <p className='text-primary-desc text-xs sm:text-sm'>Total doctor join to your portal in this month</p>
                        </div>
                    </div>
                    <div className='flex justify-between gap-3'>
                        <h2 className='font-bold text-md md:text-lg lg:text-xl xl: text-2xl'>16</h2>
                        <div className='flex items-center gap-1 text-xs md:text-md'>
                            {/* TODO: Need condition to show this data */}
                ...
                <div className='bg-white rounded-lg p-3 md:p-4 shadow'>
                    <div className='flex items-center gap-3 mb-4 md:mb-5'>
                        ...
                        <div className='space-y-1'>
                            ...
                            <p className='text-primary-desc text-xs sm:text-sm'>Total appointments scheduled for this month</p>
                        </div>
                    </div>
                    <div className='flex justify-between gap-3'>
                        <h2 className='font-bold text-md md:text-lg lg:text-xl xl: text-2xl'>1250</h2>
                        <div className='flex items-center gap-1 text-xs md:text-md'>
                            {/* TODO: Need condition to show this data */}
                ...
                <div className='bg-white rounded-lg p-3 md:p-4 shadow'>
                    <div className='flex items-center gap-3 mb-4 md:mb-5'>
                        ...
                        <div className='space-y-1'>
                            ...
                            <p className='text-primary-desc text-xs sm:text-sm'>Total revenue earned from patients this month</p>
                        </div>
                    </div>
                    <div className='flex justify-between gap-3'>
                        <h2 className='font-bold text-md md:text-lg lg:text-xl xl: text-2xl'>$3250</h2>
                        <div className='flex items-center gap-1 text-xs md:text-md'>
                            {/* TODO: Need condition to show this data */}
