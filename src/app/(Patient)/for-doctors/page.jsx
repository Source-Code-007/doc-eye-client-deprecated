    ...
    const doctorsReviews = [
        {
            ...
            review: "DocWatch is an incredible platform! It has made finding the right doctor so easy. I appreciate the user-friendly interface and the wealth of information available."
        },
        {
            id: 2,
            ...
            review: "I've been using DocWatch for a while now, and it's been a valuable resource. The search filters make it simple to find doctors in my area. Great job!"
        },
        {
            id: 3,
            ...
            review: "As a healthcare professional, I find DocWatch to be a helpful tool in connecting with colleagues and staying updated on medical advancements. It's an excellent platform for doctors."
        },
        {
            id: 4,
            ...
            review: "I recently discovered DocWatch, and it's already become my go-to for medical information. The articles and forums are informative, and the community is supportive."
        },
        {
            id: 5,
            ...
            designation: "OB/GYN",
            review: "DocWatch has been a lifesaver for me. I found a fantastic specialist for my condition through the platform, and the appointment booking feature is super convenient."
        },
        {
            id: 6,
            ...
            review: "DocWatch simplifies appointment scheduling, both for my patients and me. The user-friendly interface allows patients to book appointments online easily, reducing phone calls and administrative tasks."
        },
        {
            id: 7,
