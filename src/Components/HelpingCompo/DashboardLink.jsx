...
const DashboardLink = ({href, children}) => {
    ...
    return (
        <Link href={href} className={`text-center flex gap-[2px] items-center justify-center font-semibold py-2 px-1 rounded-l-sm relative   ${isActive && '!text-white !bg-primary-main'}`}>
