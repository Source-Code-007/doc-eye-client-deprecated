    ...
    return (
        <div className='h-screen bg-center' style={{ backgroundImage: `url(${banner1.src})` }}>
            <div className='my-container pt-28 flex flex-col justify-between h-3/4 text-center'>
                ...
                <p className='font-semibold text-lg text-slate-700 px-16'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum eius iste quis laborum cumque facilis, atque nulla quos veniam labore, modi excepturi? Expedita dolores magnam, qui non ex repudiandae sit.</p>
